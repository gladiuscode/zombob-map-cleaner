import getEnvValueBy from '../helpers/getEnvValueBy.helper';
...
const SAVES_DATA_FOLDER_PATH = path.join( homedir(), 'Zomboid', 'Saves', 'Multiplayer', getEnvValueBy('SERVER_NAME') );
